...
model_1 = rnn_bi_lstm(X_train, y_train,X_test,y_test,vocab_size,embedding_matrix, MAXLEN)
...
model_3 = rnn_lstm(X_train, y_train,X_test,y_test,vocab_size,embedding_matrix, MAXLEN)
