...
model_1 = cnn(X_train_40, y_train_40,X_test_40,y_test_40,vocab_size_40,embedding_matrix_40, MAXLEN_40,first_dropout = 0.40)
...
#4-convolutional neural net
model_2 = cnn(X_train_140, y_train_140,X_test_140,y_test_140,vocab_size_140,embedding_matrix_140, MAXLEN_140,first_dropout = 0.25)
...
model_3 = rnn_bilstm(X_train_140, y_train_140,X_test_140,y_test_140,vocab_size_140,embedding_matrix_140, MAXLEN_140)
